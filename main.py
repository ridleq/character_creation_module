...
def defence(char_name: str, char_class: str) -> str:
    """Эта функция предназначена для защиты персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Это функция применения специльных умений персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Эта функция выполняет тренировку персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Эта функция предназначена для выбора персонажа."""
    approve_choice: str = ''
    char_class: str = ''
